...
{
    std::string path_mesh = "./assets/meshs/Fire_Flower/Flowerv2.obj";
    std::vector<std::string> path_text;
    path_text.push_back("./assets/meshs/Fire_Flower/fire.png");
    irr::core::vector3df pos_world_tmp(pos_x * 10, pos_y * 10, -2);
