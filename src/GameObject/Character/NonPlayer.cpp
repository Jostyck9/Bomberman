...
NonPlayer::NonPlayer(irr::IrrlichtDevice *device, Map &map, std::vector<std::string> path_text, std::string &path_mesh, irr::s16 pos_x, irr::s16 pos_y, ACharacter::character_t character) : ACharacter(device, character), _ia(map, *this)
{
