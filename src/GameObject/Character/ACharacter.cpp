...
ACharacter::ACharacter(irr::IrrlichtDevice* device, character_t character) : PrintableObject(device), _stats(), _score(), _life(), _controller(_device, this->getDisplayInfo(), *this), _character(character), _sound()
{
}
