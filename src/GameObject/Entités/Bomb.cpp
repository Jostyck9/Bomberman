...
Bomb::Bomb(irr::IrrlichtDevice* device, ACharacter& character, irr::u16 radius, irr::core::vector2df &posMap) : myTimer(device), PrintableObject(device), _radius(radius), _posMap(posMap), _parentCharacter(character)
{
